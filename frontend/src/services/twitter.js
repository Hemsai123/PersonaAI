...
const extractPersonality = (tweets) => {
...
export const analyzeTweets = (url) => {
...
export const fetchTweets = (url) => {
    try {
        ...
        throw new TwitterError(error instanceof Error ? error.message : 'Failed to fetch tweets', error);
    }
};
