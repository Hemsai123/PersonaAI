...
export const transcribeAudio = async (audioBlob) => {
    try {
        ...
        throw new AudioError(error instanceof AudioError ? error.message : 'Failed to transcribe audio', error);
    }
};
export const startRecording = async () => {
    try {
        ...
        throw new AudioError(error instanceof Error ? error.message : 'Could not access microphone', error);
    }
};
